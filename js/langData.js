...
export const translations = {
  ...
  vi: {
    ...
    li_slide5_ex2: "Bạn có thể lựa chọn chế độ sinh tồn hoặc sáng tạo.",
  ...
  en: {
    ...
    li_slide5_ex2: "You can choose between survival or creative mode.",
